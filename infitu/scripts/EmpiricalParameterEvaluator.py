...
class EmpiricalParameterEvaluator:
    ...
    def __init__( self ):
        ...
        self.setter_proxy = rospy.ServiceProxy( setter_topic, SetParameters, True )
        ...
        self.evaluation_proxy = rospy.ServiceProxy( evaluation_topic, StartEvaluation, True )
        ...
        for name, topic in recording_topics.iteritems():
            ...
            self.recorders[name] = rospy.ServiceProxy( topic, SetRecording, True )
