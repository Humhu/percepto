#include "advant/RunningAverageBaseline.h"
                                         ...
                                         ros::NodeHandle& ph )
{
	...
	_outputPub = ph.advertise<percepto_msgs::RewardStamped>( "output", 0 );
}

double RunningAverageBaseline::GetCritique( const ros::Time& time ) const
{
	if( !IsBurnedIn() )
	{
...
void RunningAverageBaseline::RewardCallback( const percepto_msgs::RewardStamped::ConstPtr& msg )
{
